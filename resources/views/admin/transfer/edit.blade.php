            ...
            <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg shadow-xl mt-6">
                ...
                <div class="w-full p-3">
                    ...
                    <div class="border-b p-3">
                        <h3 class="text-xl font-medium text-gray-900 dark:text-white">Transfer</h3>
                    </div>
                  
                        <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="{{ route('admin.transfer.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
