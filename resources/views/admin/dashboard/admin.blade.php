    ...
    <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
        ...
        <li class="mr-6 my-2 md:my-0">
            <a href="#"
                ...
                <span class="pb-1 md:pb-0 text-sm">Wellcome to ticash</span>
            </a>
        </li>
                ...
                <div class="p-5">
                    <div class="bg-white border rounded shadow mt-4">
                        ...
                        <div class="p-5">
                            ...
                            <hr><br>
                            <h4 class="font-bold text-black">Institusi</h4>
                            <h1>{{$institutions}} Institusi</h1><br>
                            <hr><br>
                            <h4 class="font-bold text-black">Pelajar</h4>
                            <h1>{{$students}} Orang</h1><br>
                            <hr><br>
