            ...
            <div class="flex flex-col w-full mx-auto rounded-lg shadow-xl mt-6">
                ...
                <div class="w-full p-3">
                    ...
                    <div class="bg-white border rounded shadow">
                        ...
                        <h3 class="text-xl font-medium text-gray-900 dark:text-white">Edit Article</h3>
                        </div>
                        <div class="p-5">
                        ...
                        @method('PUT')                    
                            <div class="grid gap-1 grid-cols-3 grid-rows-1">
                                ...
                                <div class="mr-2">
                                    ...
                                    <input type="text" name="title" value="{{ old('title', $post->title) }}" id="title" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Article Title" required="">
                                    @error('title')
