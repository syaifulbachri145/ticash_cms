                ...
                <div class="w-full p-3">
                    ...
                    <div class="max-w-full lg:max-w-3xl xl:max-w-5xl">
                        ...
                        <div class="p-4">
                                ...
                                Balance:<strong> {{moneyFormat(Auth()->user()->balance)}}</strong> |
                            ...
                            <table class="w-full p-5 text-gray-600 text-sm">
                                <thead class="bg-gray-200">
                                    <tr>
                                        ...
                                        <th class="text-left text-gray-600 text-sm p-1">Creator</th>
                                ...
                                <tr class="border bg-white">
                                    ...
                                    <td class=" text-left p-1">{{ $member->gether->description }}</td>
                                    <td class=" text-left p-1">{{ $member->gether->user->name }}</td>
                                    <td class=" text-left p-1">{{ $member->gether->goal }}</td>
                                    <td class=" text-left p-1">{{ moneyFormat($member->gether->balance) }}</td>
                                    <td class=" text-left p-1">{{ moneyFormat($member->amount) }}</td>
                                    <td class=" text-left p-1">{{ $member->gether->deadline }}</td>
