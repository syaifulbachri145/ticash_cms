            ...
            <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg shadow-xl mt-6">
                ...
                <div class="w-full p-3">
                    ...
                    <div class="bg-white border rounded shadow">
                        ...
                        <h3 class="text-xl font-medium text-gray-900 dark:text-white">Gether</h3>
                    </div>
                  
                        <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="{{ route('admin.member.update', $member->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                    ...
                    <div class="grid gap-1 grid-cols-1 grid-rows-1">
                        ...
                        <button type="submit" class="mt-5 w-full text-white bg-blue-800 hover:bg-blue-600 focus:ring-4 focus:ring-gray-300 font-medium rounded-2xl text-sm px-5 py-2.5 text-center dark:bg-gray-500 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
