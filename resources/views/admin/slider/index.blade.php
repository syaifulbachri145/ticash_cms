                        ...
                        <div class="flex flex-1 flex-wrap">
                            ...
                            <div class="w-full p-3">
                                ...
                                <div class="max-w-full lg:max-w-3xl xl:max-w-5xl">
                                    ...
                                    <div class="p-3">
                                        <div class="p-4">
                                            <h5 class="font-bold text-gray-400"> <i class="	fas fa-film fa-fw mr-3"></i>Sliders</h5>
                                        </div>
                                    ...
                                    <div class="p-5">
                                        <table class="w-full p-5 text-gray-700 text-sm">
                                            ...
                                            <tr class="border bg-white">
                                                <th scope="row" class=" text-left p-1">{{ ++$no + ($sliders->currentPage()-1) * $sliders->perPage() }}</th>
                                                <td class=" text-left p-1">
                                                    <img src="{{ $slider->image }}" class="w-8 h-8 mr-4 rounded" style="width: 35%">
                                                    
                                                </td>
                                                <td class=" text-left p-1">{{ $slider->title }}</td>
                                                <td class="px-5 py-1 text-center">

                                                    @can('sliders.delete')
                                                    <button onClick="destroy(this.id)" id="{{ $slider->id }}" class="bg-yellow-500 px-2 py-1 rounded shadow-sm text-xs text-white focus:outline-none fas fa-trash-alt"></button>
                                                    @endcan
                                                </td>
                                            </tr>
                                            @empty
                ...
                <div class="w-full xl:w-1/3 p-6 xl:max-w-4xl border-l-1 border-gray-300">
                    ...
                    <div class="max-w-sm lg:max-w-3xl xl:max-w-5xl">
                        ...
                        <div class="border-b p-3">
                            <h5 class="font-bold text-gray-600">Add New Photo</h5>
                        </div>
                        <div class="p-3">

                            <div class="bg-white border rounded shadow">
                            <div class="p-1">
                        <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div>
                                    ...
                                    <input type="text" name="title" id="title" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Title" required="">
                                    @error('title')
                                        <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                            <div class="px-4 py-2">
                                                <p class="text-gray-600 text-sm">{{ $message }}</p>
                                ...
                                <div>
                                    <label for="link" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Link</label>
                                    <input type="text" name="link" id="link" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Direct Link" required="">
                                    @error('link')
                                        <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                            <div class="px-4 py-2">
                                                <p class="text-gray-600 text-sm">{{ $message }}</p>
