            ...
            <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg shadow-xl mt-6">
                ...
                <div class="w-full p-3">
                    ...
                    <div class="bg-white border rounded shadow">
                        ...
                        <h3 class="text-xl font-medium text-gray-900 dark:text-white">Edit Student Form</h3>
                        </div>
                        <div class="p-5">
                        <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="{{ route('admin.student.update', $student->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        ...
                        <div class="mr-2">
                            ...
                            <select name="degree_id" id="degree_id" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                    <option value="{{ $student->degree_id}}">{{ $student->degree->degree_name}}</option>
                        ...
                        <div class="mr-2">
                            ...
                            <input type="number" name="nim" value="{{ old('nim',$student->nim) }}" id="nim" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="NIM" required="">
                            @error('nim')
                    ...
                    <div class="grid gap-1 grid-cols-3 grid-rows-1">
                        ...
                        <div class="mr-2">
                            ...
                            <input type="text" name="major" value="{{ old('major',$student->major) }}" id="major" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Major" required="">
                            @error('major')
                                <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                    <div class="px-4 py-2">
                                        <p class="text-gray-600 text-sm">{{ $message }}</p>
                        ...
                        <div class="mr-2">
                            ...
                            <input type="number" name="graduation" value="{{ old('graduation',$student->graduation) }}" id="graduation" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Graduation" required="">
                            @error('graduation')
                                <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                    <div class="px-4 py-2">
                                        <p class="text-gray-600 text-sm">{{ $message }}</p>
