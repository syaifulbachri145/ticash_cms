@extends ('layouts.app', ['title' => 'Student - Admin'])
            ...
            <div class="flex flex-1 flex-wrap">
                ...
                <div class="w-full p-3">
                    ...
                    <div class="max-w-full lg:max-w-3xl xl:max-w-5xl">
                        ...
                        <div class="p-3">
                            <div class="p-4">
                                <h5 class="font-bold text-gray-400"> <i class="	fas fa-server fa-fw mr-3"></i>student</h5>
                            </div>
                            ...
                            <table class="w-full p-5 text-gray-600 text-sm">
                                <thead class="bg-gray-200">
                                    <tr>
                                        ...
                                        <th class="text-left text-gray-600 text-sm p-1">NIM</th>
                                        <th class="text-left text-gray-600 text-sm p-1">Major</th>
                                        <th class="text-left text-gray-600 text-sm p-1">Degree</th>
                                        <th class="text-left text-gray-600 text-sm p-1">Graduation</th>
                                ...
                                <tr class="border bg-white">
                                    <th scope="row" class=" text-left p-1">{{ ++$no + ($students->currentPage()-1) * $students->perPage() }}</th>
                                    <td class=" text-left p-1">{{ $student->institution->institution_name }}</td>
                                    <td class=" text-left p-1">{{ $student->user->name }}</td>
                                    <td class=" text-left p-1">{{ $student->nim }}</td>
                                    <td class=" text-left p-1">{{ $student->major }}</td>
                                    <td class=" text-left p-1">{{ $student->degree->degree_name }}</td>
                                    <td class=" text-left p-1">{{ $student->graduation }}</td>
                                    <td class=" text-left p-1">{{ $student->status }}</td>
                                    <td class="px-5 py-1 text-center">
                                  
                                        @can('students.edit')
                                        <a href="{{ route('admin.student.edit', $student->id) }}" class="bg-gray-500 px-2 py-0.5 rounded shadow-sm text-xs text-white focus:outline-none">
                                        <i class="fas fa-edit text-center"></i></a>
                                        @endcan
                                        
                                        @can('students.delete')
                                        <button onClick="destroy(this.id)" id="{{ $student->id }}" class="bg-yellow-500 px-2 py-1 rounded shadow-sm text-xs text-white focus:outline-none fas fa-trash-alt"></button>
                                        @endcan
                                    </td>
        ...
        <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl">
            ...
            <div class="bg-white rounded-lg shadow relative dark:bg-gray-700">
                <div class="flex justify-end p-2 border-b">
                    <h3 class="text-xl font-medium text-gray-900 dark:text-white">Add student Form</h3>
                ...
                <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="{{ route('admin.student.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="grid gap-1 grid-cols-3 grid-rows-1">
                        ...
                        <div class="mr-2">
                            <label for="nim" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">NIM</label>
                            <input type="number" name="nim" value="{{ old('nim') }}" id="nim" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="NIM" required="">
                            @error('nim')
                    ...
                    <div class="grid gap-1 grid-cols-3 grid-rows-1">
                        ...
                        <div class="mr-2">
                            <label for="major" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Major</label>
                            <input type="text" name="major" value="{{ old('major') }}" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Major" required="">
                            @error('major')
                                <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                    <div class="px-4 py-2">
                                        <p class="text-gray-600 text-sm">{{ $message }}</p>
                        ...
                        <div class="mr-2">
                            <label for="graduation" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Graduation</label>
                            <input type="number" name="graduation" value="{{ old('graduation') }}" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Graduation" required="">
                            @error('graduation')
                                <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                    <div class="px-4 py-2">
                                        <p class="text-gray-600 text-sm">{{ $message }}</p>
