@extends ('layouts.app', ['title' => 'Article - Category'])
                            ...
                            <div class="flex flex-1 flex-wrap">
                                ...
                                <div class="w-full p-3">
                                    ...
                                    <div class="max-w-full lg:max-w-3xl xl:max-w-5xl">
                                        ...
                                        <div class="p-3">
                                            <div class="p-4">
                                                <h5 class="font-bold text-gray-400"> <i class="	fas fa-film fa-fw mr-3"></i>Article / Category</h5>
                                            </div>
                                            ...
                                            <div class="flex">
                                                ...
                                                <button data-modal-toggle="create-modal" class="text-white focus:outline-none bg-gray-600 hover:bg-gray-500 px-2 py-1 shadow-sm rounded-md">
                                                    <i class="fas fa-file-alt mr-2"></i> Add New Category
                                                </button>
                                                @endcan
                            ...
                            <div class="flex flex-row flex-wrap flex-grow mt-2">
                                ...
                                <div class="bg-white border rounded shadow">
                                        <div class="border-b p-3">
                                            <h5 class="font-bold text-gray-600 text-sm">Table Post Categories</h5>
                                        </div>
                                        <div class="p-5">
                                            <table class="w-full p-5 text-gray-600 text-sm">
                                                ...
                                                <tr class="border bg-white">
                                                    ...
                                                    <td class=" text-left p-1">{{ $category->slug }}</td>
                                                    <td class="px-5 py-1 text-center">
                                                        @can('post-categories.edit')
                                                        <a href="{{ route('admin.postCategory.edit', $category->id) }}" class="bg-gray-500 px-2 py-0.5 rounded shadow-sm text-xs text-white focus:outline-none">
