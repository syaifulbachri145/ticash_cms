            ...
            <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg shadow-xl mt-6">
                ...
                <div class="w-full p-3">
                    ...
                    <div class="bg-white border rounded shadow">
                        ...
                        <h3 class="text-xl font-medium text-gray-900 dark:text-white">Edit Post Category Form</h3>
                        </div>
                        <div class="p-5">
                        <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="{{ route('admin.postCategory.update', $postCategory->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="grid gap-1 grid-cols-2 grid-rows-1">
                                <div class="mr-2">
                                    ...
                                    <input type="text" name="name" value="{{ $postCategory->name }}" id="name" value="" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Your Name" required="">
                                    @error('name')
