...
<div class="bg-white-700 pl-2 md:pl-10 w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-2 z-10 border-yellow-500" id="nav-content" >
                        ...
                        <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                            ...
                            <li class="mr-6 my-2 md:my-0">
                                ...
                                class="block py-1 md:py-3 pl-1 align-middle text-gray-800 no-underline hover:text-blue-600 border-b-2 hover:border-blue-600 {{ Request::is('admin/slider*') ? 'text-blue-600 border-blue-600' :  'text-white'}} ">
                                   <span class="pb-1 md:pb-0 text-sm">Slider</span>
                                </a>
                            </li>
                            @endcan
